...
def _two_env_placeholder_scene(*, device: str = "cpu"):
...
def test_broadcast_joint_q_device_matches_host():
    scene = _two_env_placeholder_scene(device="cpu")
    layout, w0_q, w0_qd = _perturb_world0_joint_q(scene)

    host_scene = _two_env_placeholder_scene(device="cpu")
...
def test_broadcast_robot_template_device_matches_host():
    ...
    dev_model = _two_env_placeholder_scene(device="cpu").robot_model
